package com.ezt.video.instasaver.customview;
...
public final class PausableProgressBar extends FrameLayout {
     ...
     */
    public static final int DEFAULT_PROGRESS_DURATION = 2000;
    ...
    public void finishProgress(boolean isMax) {
